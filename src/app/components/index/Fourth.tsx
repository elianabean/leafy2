...
export default function Fourth() {
    return (
        <div className="flex flex-col grid-rows-2 md:grid md:grid-cols-2 md:grid-rows-1 items-center justify-center ">
            <div className=" md:py-16">
                <div className="flex items-center justify-center py-24 border-b-4 md:border-b-0 md:border-r-4 border-primary">
            ...
            <div className="bg-white flex items-start justify-center md:py-16">
                <div
                className="w-full h-full flex flex-col items-center justify-center py-20 px-16 md:px-32 md:text-start text-center"
                >
                <h1
